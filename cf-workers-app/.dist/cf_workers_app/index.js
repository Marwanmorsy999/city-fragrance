...
var RouterCore = class {
  ...
  */
  ...
  setRoutes({ routesById, routesByPath, processedTree }) {
    ...
    if (notFoundRoute2) {
      notFoundRoute2.init({ originalIndex: 99999999999 });
...
function CatchNotFound(props) {
  const router2 = useRouter();
  {
    const resetKey = `not-found-${router2.stores.location.get().pathname}-${router2.stores.status.get()}`;
...
function MatchView({ router: router2, matchId, resetKey, matchState }) {
  ...
  }), matchState.parentRouteId === rootRouteId ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [/* @__PURE__ */ jsxRuntimeExports.jsx(OnRendered, {}), router2.options.scrollRestoration && isServer ? /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollRestoration, {}) : null] }) : null] });
}
function OnRendered() {
  useRouter();
  return null;
...
var MatchInner = reactExports.memo(function MatchInnerImpl({ matchId }) {
  ...
  };
  {
    ...
    if (match2.status === "error") return /* @__PURE__ */ jsxRuntimeExports.jsx((route2.options.errorComponent ?? router2.options.defaultErrorComponent) || ErrorComponent, {
      error: match2.error,
      reset: void 0,
      info: { componentStack: "" }
    });
...
function MatchesInner() {
  const router2 = useRouter();
  const matchId = router2.stores.firstId.get();
  const resetKey = router2.stores.loadedAt.get();
...
function header() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "border-b", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", className: "font-semibold text-lg", children: "App" }) }) });
}
function footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t py-6 text-center text-sm text-muted-foreground", children: "Built with Cloudflare Workers + Neon PostgreSQL" });
}
function App$1() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { children: header() }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { children: footer() })
  ] });
}
function Home() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-bold tracking-tight", children: "Cloudflare Workers App" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-lg text-muted-foreground", children: "Scaffolded with Vite, TanStack Router, and Neon PostgreSQL on Cloudflare Workers." })
  ] });
}
function NotFound() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-8 text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-6xl font-bold", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-lg text-muted-foreground", children: "Page not found." })
  ] });
}
